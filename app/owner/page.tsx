...
export default async function OwnerPage() {
  ...
  const [providers, { data: profiles }] = await Promise.all([
    ...
    licenses.length ? client.from("provider_profiles").select("license_number, description, website, contact_email, contact_phone").in("license_number", licenses) : { data: [] }
  ]);
